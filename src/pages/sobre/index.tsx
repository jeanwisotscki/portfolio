      ...
      <Container>
        ...
        <TextContainer>
          <article>
            ...
            <p>
              Estudante de Analise e Desenvolvimento de Sistemas pela UNINTER,
              em busca da primeira oportunidade profissional na area.
            </p>
            <br />
            <p>
          ...
          <article>
            ...
            <p>
              ...
              />{" "}
              e tive meu primeiro contato com <strong>Python</strong> e entendi
              um pouco mais sobre lógica de programação.
            </p>
            <br />
            <p>
              Estudei Python por alguns meses e comecei a sentir a necessidade
              de algo mais palpável. Foi aí que eu comecei a aprender sobre{" "}
            ...
            <p>
              ...
              desistir. Mas não por muito tempo, só até eu conseguir me
              organizar melhor com o trabalho. Perto do final de 2021 eu
              retornei aos estudos, dessa vez focado em aprender{" "}
              <LinkButton
            ...
            <br />
            <p>
              Em 2022, me matriculei na faculdade e passei a me dedicar de
              verdade nos estudos. Terminei o curso de <strong>React</strong>,
              comecei fazer os meus próprios projetos e a coloca-los no github,
              aprendi um pouco sobre o framework{" "}
              <LinkButton href="https://nextjs.org/" textContent="Next.js" /> e
              os conceitos de <strong>SSR (Server Side Rendering)</strong>,
              comecei os estudos em{" "}
              <LinkButton
                href="https://www.typescriptlang.org/"
                textContent="TypeScript"
              />{" "}
